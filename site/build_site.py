...
.sheet{background:var(--deck);border-radius:16px;padding:24px 20px 8px;margin:0 0 28px;overflow:auto}
.sheet img{display:block;width:100%;min-width:900px;height:auto}
...
<div class="wrap">
  ...
  <section id="actions">
    ...
    <div class="sheet"><img src="{img('actions.png')}" width="1492" height="194" alt="All ten actions: Allow once, Allow for session, Always allow, Deny, Stop, Reply, Shortcut, Activate Claude, Claude Status, Inspect"></div>
    <table>
